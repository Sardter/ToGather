...
class RatedProfileAPIModelService extends APIModelService<RatedUser> {
  @override
...
class RatedProfileTestModelService extends ModelService<RatedUser> {
  @override
  ...
  @override
  Future<RatedUser?> getItem({required ItemParameters itemParameters}) async {
        await Future.delayed(Duration(milliseconds: 750));


    return RatedUser(
        id: 1,
        about: "RatedUser About",
        rate: 5,
  ...
  @override
  Future<List<RatedUser>?> getList({QueryParameters? queryParameters}) async {
        await Future.delayed(Duration(milliseconds: 750));
  ...
  @override
  Future<RatedUser?> updateItem(
      {required RatedUser updatedItem,
  ...
  @override
  Future<RatedUser?> postItem({required RatedUser item}) async {
        await Future.delayed(Duration(milliseconds: 750));
